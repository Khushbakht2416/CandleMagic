    ...
    (e = function () {
        ...
        class ft extends W {
                ...
                if (
                    (this._config.parent &&
                        (t = this._getFirstLevelChildren(
                            ...
                            .map((t) =>
                                ft.getOrCreateInstance(t, { toggle: !1 })
                            )),
                    t.length && t[0]._isTransitioning)
                )
                    return;
                if (
                    I.trigger(this._element, "show.bs.collapse")
                        .defaultPrevented
                )
                    return;
            ...
            hide() {
                if (this._isTransitioning || !this._isShown()) return;
                if (
                    I.trigger(this._element, "hide.bs.collapse")
                        .defaultPrevented
                )
                    return;
            ...
            _configAfterMerge(t) {
                return (
                    (t.toggle = Boolean(t.toggle)), (t.parent = s(t.parent)), t
                );
            }
            _getDimension() {
        ...
        function Ut(t, e, i) {
            ...
            e &&
                ...
                (o =
                    (t.offsetHeight > 0 && Qt(n.height) / t.offsetHeight) ||
                    1));
        ...
        function ke(t, e) {
            ...
            var i = e,
                ...
                w = (function (t, e, i, n) {
                    ...
                    Wt(y) ? y : y.contextElement || ee(t.elements.popper),
                    l,
                    h,
                    r
                ),
        ...
        var Be = We(),
            ze = We({ defaultModifiers: [me, Pe, fe, Rt] }),
            Re = We({ defaultModifiers: [me, Pe, fe, Rt, Ne, Le, je, ce, Ie] });
        ...
        class li extends W {
            constructor(t, e) {
                super(t, e),
                    ...
                    (this._menu =
                        z.next(this._element, Ze)[0] ||
                        z.prev(this._element, Ze)[0] ||
                        z.findOne(Ze, this._parent)),
            ...
            static dataApiKeydownHandler(t) {
                ...
                if (e && !i) return;
                t.preventDefault();
                const s = this.matches(Ge)
                        ? this
                        : z.prev(this, Ge)[0] ||
                          z.next(this, Ge)[0] ||
                          z.findOne(Ge, t.delegateTarget.parentNode),
        ...
        I.on(document, Ye, Ge, li.dataApiKeydownHandler),
            I.on(document, Ye, Ze, li.dataApiKeydownHandler),
            I.on(document, Xe, li.clearMenus),
            I.on(document, "keyup.bs.dropdown.data-api", li.clearMenus),
            I.on(document, Xe, Ge, function (t) {
        ...
        class Di extends W {
            ...
            show(t) {
                this._isShown ||
                    ...
                    I.trigger(this._element, Ci, { relatedTarget: t })
                        .defaultPrevented ||
                    ((this._isShown = !0),
                    (this._isTransitioning = !0),
            ...
            hide() {
                this._isShown &&
                    !this._isTransitioning &&
                    (I.trigger(this._element, "hide.bs.modal")
                        .defaultPrevented ||
                        ((this._isShown = !1),
                        (this._isTransitioning = !0),
                ...
                for (const e of t)
                    if ("click" === e)
                        ...
                        I.on(this._element, t, this._config.selector, (t) => {
                            ...
                            (e._activeTrigger["focusin" === t.type ? nn : en] =
                                !0),
                                e._enter();
                        }),
                            I.on(
        ...
        class gn extends W {
            ...
            _maybeEnableSmoothScroll() {
                this._config.smoothScroll &&
                    (I.off(this._config.target, dn),
                    I.on(this._config.target, dn, fn, (t) => {
        ...
        I.on(document, "click.bs.tab", Tn, function (t) {
            ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
                r(this) || On.getOrCreateInstance(this).show();
        }),
        ...
        class In extends W {
            ...
            hide() {
                this.isShown() &&
                    (I.trigger(this._element, "hide.bs.toast")
                        .defaultPrevented ||
