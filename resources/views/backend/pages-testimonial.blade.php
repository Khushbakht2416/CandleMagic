...
<head>
  ...
  <title>Testimonial - Candle Magic</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-right mb-3">
                <a href="{{ url('/admin/add-testimonial') }}" class="btn btn-primary" style="color: white;">Add New Testimonial</a>
              </div>
              <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        @if($row->status == 0)
                          <a  href="{{ url('/admin/enable-testimonial/' . $row->id) }}" class="btn btn-warning"><i class="fas fa-toggle-off"></i></a>

                        @else
                          <a  href="{{ url('/admin/disable-testimonial/' . $row->id) }}" class="btn btn-success"><i class="fas fa-toggle-on"></i></a>
                        @endif
                      </td>
                      <td>
                      <a  href="{{ url('/admin/edit-testimonial/' . $row->id) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                        <a  href="{{ url('/admin/delete-testimonial/' . $row->id) }}" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
