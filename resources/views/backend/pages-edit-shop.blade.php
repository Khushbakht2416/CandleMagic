...
<head>
  ...
  <title>Edit Shop - Candle Magic</title>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Edit the Product - {{ $shop->pname }}
                            </p>
                            <h5 class="card-title">Details of the product</h5>
                            <form method="POST" action="{{ url('/admin/edit-shop/' . $shop->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-floating mb-3">
                                    <select class="form-control" name="saletag">
                                        <option value="Sale" {{ $shop->saletag == 'Sale' ? 'selected' : '' }}>Sale
                                        </option>
                                        <option value="Not Sale" {{ $shop->saletag == 'Not Sale' ? 'selected' : '' }}>Not
                                            Sale</option>
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    <input type="hidden" name="imgurlprevious" value="{{ $shop->imgurl }}">
                                    @if ($shop->imgurl)
                                        <div class="m-5">
                                            <img src="{{ asset($shop->imgurl) }}" style="width: 150px; height: 120px"
                                                alt="Current Image">
                                        </div>
                                    @endif
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="pname" value="{{ $shop->pname }}"
                                        placeholder="">
                                ...
                                @endif
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="quantity" value="{{ $shop->quantity }}" min="0" placeholder="Enter quantity">
                                ...
                                <!-- Bestselling Field (Dropdown) -->
                                <div class="form-floating mb-3">
                                    <select class="form-control" name="bestselling">
                                        <option value="Yes" {{ $shop->bestselling == 1 ? 'selected' : '' }}>Yes</option>
                                        <option value="No" {{ $shop->bestselling == 0 ? 'selected' : '' }}>No</option>
                                    </select>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="description"
                                        value="{{ $shop->description }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="information"
                                        value="{{ $shop->information }}" placeholder="">
                                    <label for="title">Detail Product Information</label>
                                </div>
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-control" name="company">
                                        <option value="IGET Bar" {{ $shop->company == 'IGET Bar' ? 'selected' : '' }}>IGET Bar</option>
                                        <option value="IGET Moon" {{ $shop->company == 'IGET Moon' ? 'selected' : '' }}>IGET Moon</option>
                                        <option value="AliBar" {{ $shop->company == 'AliBar' ? 'selected' : '' }}>AliBar</option>
                                        <option value="KUZ" {{ $shop->company == 'KUZ' ? 'selected' : '' }}>KUZ</option>
                                    </select>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="duration"
                                        value="{{ $shop->duration }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="actualprice"
                                        value="{{ $shop->actualprice }}" placeholder="">
                                    <label for="uploadedby">ActualPrice</label>
                                </div>
                                ...
                                @endif
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="afterdiscount"
                                        value="{{ $shop->afterdiscount }}" placeholder="">
                                    <label for="uploadedby">AfterDiscount</label>
                                </div>
