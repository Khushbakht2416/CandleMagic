                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-xxl-4 col-md-6">
                            <a href="{{ url('/admin/bestselling') }}" class="card info-card bestselling-card">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <a href="{{ url('/admin/product_reviews') }}" class="card info-card customers-card">
                                <div class="card-body">
                        ...
                        <!-- Add these new cards after the existing Contact card -->
                        <div class="col-xxl-4 col-md-6">
                            <a href="{{ url('/admin/customers') }}" class="card info-card customers-card">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <a href="{{ url('/admin/payments') }}" class="card info-card payments-card">
                                <div class="card-body">
                        ...
                        <div class="col-xxl-4 col-md-6">
                            <a href="{{ url('/admin/orders') }}" class="card info-card orders-card">
                                <div class="card-body">
