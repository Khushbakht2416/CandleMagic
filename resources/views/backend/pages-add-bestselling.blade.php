                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Candle Magic - Enable Product to Best Selling Product</p>
                                ...
                                <tbody>
                                    @foreach ($bestselling as $row)
                                        <tr>
                                            <td>{{ $row->id }}</td>
                                            <td>
                                                <img src="../{{ $row->imgurl }}" alt="Image not found"
                                            ...
                                            <td>
                                                @if ($row->bestselling == 0)
                                                    <a href="{{ url('/admin/enable-bestselling/' . $row->id) }}"
                                                        class="btn btn-warning">
                                                        <i class="fas fa-toggle-off"></i>
                                                    </a>
                                                @else
                                                    <a href="{{ url('/admin/disable-bestselling/' . $row->id) }}"
