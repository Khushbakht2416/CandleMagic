...
<head>
  ...
  <title>Edit Testimonial - Candle Magic</title>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>Empowering excellence with every update!</p>
                        <h5 class="card-title">Details of the Testimonial page</h5>
                        <form method="POST" action="{{ url('/admin/edit-testimonial/'. $testimonial->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="author" value="{{ $testimonial->author }}" placeholder="">
                                <label for="title">Author</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="title" value="{{ $testimonial->title }}" placeholder="">
                                <label for="title">Title</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" name="description" value="{{ $testimonial->description}}" placeholder="">
                                <label for="uploadedby">Description</label>
                            </div>
                            <div class="form-group mb-3">
                                <input type="hidden" name="imgurlprevious" value="{{ $testimonial->imgurl }}">
                                @if($testimonial->imgurl)
                                    <div class="m-5">
                                        <img src="{{ asset($testimonial->imgurl) }}" style="width: 150px; height: 120px" alt="Current Image">
                                    </div>
                                @endif
