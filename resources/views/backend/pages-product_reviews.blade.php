...
<head>
  ...
  <title>Reviews - Candle Magic</title>
    ...
    <section class="section">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Customer Name: {{ $product_reviews->rname }}</h5>
                        <h6 class="card-subtitle mb-2 text-muted">{{ $product_reviews->email }}</h6>
                        <p class="card-text">Review: {{ $product_reviews->rmessage }}</p>
                        <p class="card-text"> Product id: {{ $product_reviews->product_id }}</p>
                        <p class="card-text"><small class="text-muted">Received: {{ $product_reviews->created_at->format('M d, Y H:i:s') }}</small></p>
                        <a href="{{ url('/admin/product_reviews/' . $product_reviews->id) }}"
