...
<head>
  ...
  <title>Edit Best Selling - Candle Magic</title>
...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Edit BestSelling Page</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/admin') }}">Home</a></li>
                    <li class="breadcrumb-item">Pages</li>
                    <li class="breadcrumb-item active">Edit BestSelling</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit BestSelling</h5>
                            <p>This is an examle page with no contrnt. You can use it as a starter for your custom pages.
                            </p>
                            <h5 class="card-title">Details of BestSelling Products</h5>
                            <form method="POST" action="{{ url('/admin/edit-bestselling/' . $bestselling->id) }}"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-floating mb-3">
                                    <select class="form-control" name="saletag">
                                        <option value="Sale" {{ $bestselling->saletag == 'Sale' ? 'selected' : '' }}>Sale
                                        </option>
                                        <option value="Not Sale" {{ $bestselling->saletag == 'Not Sale' ? 'selected' : '' }}>Not
                                            Sale</option>
                                    </select>
                                    <label for="saletag">SaleTag</label>
                                </div>
                                <div class="form-group mb-3">
                                    <input type="hidden" name="imgurlprevious" value="{{ $bestselling->imgurl }}">
                                    @if ($bestselling->imgurl)
                                        <div class="m-5">
                                            <img src="{{ asset($bestselling->imgurl) }}" style="width: 150px; height: 120px"
                                                alt="Current Image">
                                        </div>
                                    @endif
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="pname"
                                        value="{{ $bestselling->pname }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="company"
                                        value="{{ $bestselling->company }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="duration"
                                        value="{{ $bestselling->duration }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="description"
                                        value="{{ $bestselling->description }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="actualprice"
                                        value="{{ $bestselling->actualprice }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="afterdiscount"
                                        value="{{ $bestselling->afterdiscount }}" placeholder="">
