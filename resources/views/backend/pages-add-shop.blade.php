...
<head>
  ...
  <title>Add Product - Candle Magic</title>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Details of the New Product</h5>
                            <form method="POST" action="{{ url('/admin/add-shop') }}" enctype="multipart/form-data">
                                @csrf

                                <div class="form-floating mb-3">
                                    <select class="form-control" name="saletag" id="saletag">
                                        <option value="Not Sale" {{ old('saletag') == 'Not Sale' ? 'selected' : '' }}>Not Sale</option>
                                        <option value="Sale" {{ old('saletag') == 'Sale' ? 'selected' : '' }}>Sale</option>
                                    </select>
                                    @if ($errors->has('saletag'))
                                        <span class="text-danger">{{ $errors->first('saletag') }}</span>
                                    @endif
                                    <label for="saletag">Saletag</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="pname" value="{{ old('pname') }}" placeholder="">
                                    @if ($errors->has('pname'))
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="information" value="{{ old('information') }}" placeholder="">
                                    @if ($errors->has('information'))
                                        <span class="text-danger">{{ $errors->first('information') }}</span>
                                    @endif
                                    <label for="information">Product Detail Information</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <select class="form-control" name="company" id="company">
                                        <option value="IGET Bar" {{ old('company') == 'IGET Bar' ? 'selected' : '' }}>IGET Bar</option>
                                        <option value="IGET Moon" {{ old('company') == 'IGET Moon' ? 'selected' : '' }}>IGET Moon</option>
                                        <option value="AliBar" {{ old('company') == 'AliBar' ? 'selected' : '' }}>AliBar</option>
                                        <option value="KUZ" {{ old('company') == 'KUZ' ? 'selected' : '' }}>KUZ</option>
                                    </select>
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="duration" value="{{ old('duration') }}" placeholder="">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="actualprice" value="{{ old('actualprice') }}" placeholder="">
                                    @if ($errors->has('actualprice'))
                                        <span class="text-danger">{{ $errors->first('actualprice') }}</span>
                                    @endif
                                    <label for="actualprice">ActualPrice</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="afterdiscount" value="{{ old('afterdiscount') }}" placeholder="">
                                    @if ($errors->has('afterdiscount'))
                                        <span class="text-danger">{{ $errors->first('afterdiscount') }}</span>
                                    @endif
                                    <label for="afterdiscount">AfterDiscount</label>
                                </div>
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-control" name="bestselling" id="bestselling">
                                        <option value="Yes" {{ old('bestselling') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                        <option value="No" {{ old('bestselling') == 'No' ? 'selected' : '' }}>No</option>
                                    </select>
                                    @if ($errors->has('bestselling'))
                                        <span class="text-danger">{{ $errors->first('bestselling') }}</span>
                                    @endif
