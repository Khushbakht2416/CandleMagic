...
<head>
  ...
  <title>Best Selling - Candle Magic</title>
      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <p>Candle Magic - All best selling products list here</p>
            <div class="text-right mb-3">
              <a href="{{ url('/admin/add-bestselling') }}" class="btn btn-primary" style="color: white;">
                <i></i> Add New Best Selling Product
              </a>
            </div>
            <table class="table">
              <thead>
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('/admin/delete-bestselling/' . $row->id) }}" class="btn btn-danger">
