            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                    <div class="login-register p-4 border rounded shadow-sm">
                        <h3 class="login-register__title text-center">Log In</h3>
                        ...
                        @endif
                        <form action="{{ url('/user/onlogin') }}" method="POST">
                            @csrf
                            <div class="login-register__form">
                                <div class="single-form mb-3">
                                    <input class="single-form__input form-control" type="text" name="email"
                                ...
                                <div class="single-form text-center">
                                    <a href="{{ url('/user/register') }}">Don't have an account? Register Now</a>
                                </div>
                            </div>
                        </form>
                    </div>
