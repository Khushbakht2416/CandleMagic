...
<head>
    ...
    <title>Candle Magic || Contact Us</title>
        ...
        <div class="contact-us-section section-padding-2">
            <div class="container-fluid custom-container">
                ...
                <div class="contact-us-wrapper">
                    <div class="row gy-5 d-flex justify-content-center align-items-center min-vh-100">
                        <div class="col-md-8 justify-items-center">
                            <!-- Contact Us Start -->
                                ...
                                <div class="contact-us-form">
                                    ...
                                    <form method="post" action="{{ url('/contact-us') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="single-form">
                                                    ...
                                                    <input class="single-form__input" type="text" name="fname"
                                                        value="{{ old('fname') }}" />
                                                    @if ($errors->has('fname'))
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="single-form">
                                                    ...
                                                    <input class="single-form__input" type="text" name="lname"
                                                        value="{{ old('lname') }}" />
                                                    @if ($errors->has('lname'))
                                                        <span class="text-danger">
                                                            {{ $errors->first('lname') }}
                                        ...
                                        <div class="single-form">
                                            ...
                                            <textarea class="single-form__input" name="message" value="{{ old('message') }}"></textarea>
