...
<head>
    ...
    <title>Candle Magic || About</title>
...
<body>
    ...
    <main>
        <!-- About Start -->
        <div class="about-section-2 section-padding">
            <div class="container-fluid custom-container">
                <!-- About Title Start -->
                <div class="about-title text-center js-scroll ShortFadeInUp">
                    <h2 class="about-title__title">Crafting Warmth and Ambiance</h2>
                    <p>
                        We specialize in creating beautifully handcrafted candles that enhance the atmosphere of any space. Our candles are designed to add a touch of warmth, serenity, and elegance to your home, making every moment special and memorable.
                    </p>
                </div>
                <!-- About Title End -->
                        ...
                        <div class="about-item js-scroll ShortFadeInUp">
                            <div class="about-item__top">
                                <div class="about-item__top--image">
                                    <img src="{{ $section->imgurl}}" alt="About" width="391" height="510" />
                                </div>
                                <h3 class="about-item__top--title" style="color: black">
                                    {{ $section->title}}
                                </h3>
                            </div>
        ...
        <div class="about-video js-scroll ShortFadeInUp" style="background-image: url(frontend/images/slider/slider-1.jpg)">
            <div class="container-fluid custom-container">
                <h3 style="font-size: 40px">
                    Candles and calm vibes.
                </h3>
                <p style="font-size: 20px">Glow on and shine bright!</p>
            </div>
        </div>
