        ...
        <div class="breadcrumb-section">
            <div class="container-fluid custom-container">
                <div class="breadcrumb-wrapper text-center">
                    <h2 class="breadcrumb-wrapper__title">Order Tracking</h2>
            ...
            <div class="container-fluid custom-container">
                <div class="cart-wrapper">
                    <div class="cart-form">
                        ...
                        <h3 class="billing-info__title">Order Status</h3>
                        <div class="cart-totals__checkout p-2 w-100 d-flex justify-content-center">
                            <a href="#">{{ $order->status }}</a>
                        </div>
                        <div class="billing-info">
                            <h3 class="billing-info__title">Billing Information</h3>
                            ...
                            <div class="billing-info__table">
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <th>Name</th>
                                            <td>{{ $order->billing_details['first_name'] }} {{ $order->billing_details['last_name'] }}</td>
                                        </tr>
                                        <tr>
                                            <th>Email</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {{ $order->billing_details['address_line1'] }},
                                                @if($order->billing_details['address_line2'])
                                                    {{ $order->billing_details['address_line2'] }},
                                                @endif
                        ...
                        <div class="free-shipping-goal">
                            <div class="free-shipping-goal__label">
                                <h3 class="billing-info__title">Product Details</h3>
                            </div>
                        </div>
                                    ...
                                    @foreach ($orderDetails as $item)
                                        <tr class="cart-item">
                                            <td class="cart-product-thumbnail">
                                                <a href="{{ url('product' . '/' . $item['name'] . '/' . $item['options']['ptoken']) }}">
                                                    <img src="{{ asset($item['options']['imgurl']) }}" alt="Product" width="100" height="120" />
                                                </a>
                                            </td>
                    ...
                    <div class="cart-collaterals">
                        <div class="cart-totals">
                            <h3 class="cart-totals__title">Payment Details</h3>
                                ...
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span id="payment-method">{{ $payment->payment_method }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <th>Subtotal</th>
                                            <td>
                                                <span id="subtotal-amount">${{ $payment->amount - $shippingCost }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="order-total">
                                            <th>Total</th>
                                            <td>
                                                <strong id="total-amount">${{ $payment->amount }}</strong>
                                            </td>
                                        </tr>
