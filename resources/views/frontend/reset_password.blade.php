        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="login-register">
                    <h3 class="login-register__title">Reset Your Password</h3>
                    @if (session('status'))
                    ...
                    <form action="{{ route('password.update') }}" method="POST">
                        ...
                        <div class="login-register__form">
                            <div class="single-form">
                                <input class="single-form__input" type="password" name="password" placeholder="New Password *" required />
                            ...
                            <div class="single-form">
                                <input class="single-form__input" type="password" name="password_confirmation" placeholder="Confirm Password *" required />
                            ...
                            <div class="single-form">
                                <button class="single-form__btn btn" style="width: 100%">
                                    Reset Password
                                </button>
                            </div>
                        </div>
