...
<head>
    ...
    <title>Candle Magic || Order Tracking</title>
    ...
    <main>
        ...
        <center>
            @if ($message = Session::get('success'))
                <div class="alert alert-success p-4 w-10" style="background-color: #aab17d; opacity: 1; text-align: center;">
                    <h2 style="color: black; margin: 0;">{{ $message }}</h2>
                </div>
            @endif

            @if ($message = Session::get('error'))
                <div class="alert alert-danger p-4 w-100" style="background-color: #ffcccc; opacity: 1; text-align: center;">
                    <h2 style="color: black; margin: 0;">{{ $message }}</h2>
                </div>
            @endif
        </center>
            ...
            <div class="order-tracking-wrapper">
                <div class="row g-0 flex-row-reverse">
                    <div class="col-md-6">
                        ...
                        <div class="order-tracking-form">
                            <div class="order-tracking-form__wrapper">
                                ...
                                <form action="{{ route('trackingorder') }}" method="POST">
                                    @csrf
                                    <div class="single-form">
                                        <label class="single-form__label" for="orderId">Order ID</label>
                                        <input class="single-form__input" type="text" name="orderId"
                                            id="orderId" placeholder="Found in your order confirmation email."
                                            required value="{{ old('orderId') }}" />
                                        @if ($errors->has('orderId'))
                                            <span class="text-danger">{{ $errors->first('orderId') }}</span>
                                        @endif
                                    </div>
                                    <div class="single-form">
                                        <label class="single-form__label" for="transactionId">Transaction ID</label>
                                        <input class="single-form__input" type="text" name="transactionId"
                                            id="transactionId" placeholder="Found in your order confirmation email."
                                            required value="{{ old('transactionId') }}" />
                                        @if ($errors->has('transactionId'))
                                            <span class="text-danger">{{ $errors->first('transactionId') }}</span>
                                        @endif
                                    </div>
                                    <div class="single-form">
                                        <label class="single-form__label" for="email">Billing Email</label>
                                        <input class="single-form__input" type="email" name="email"
                                            id="email" placeholder="Email you used during checkout." required
                                            value="{{ old('email') }}" />
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="single-form">
                                        <button class="single-form__btn btn" type="submit">Track</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="order-tracking-banner text-center"
                            style="
                                    background-image: url(frontend/images/products/candles/product-09.jpg);
                                ">
                        </div>
