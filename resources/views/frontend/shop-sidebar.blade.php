                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="single-product js-scroll ShortFadeInUp">
                                                <div class="single-product__thumbnail">
                                                    ...
                                                    <div class="single-product__thumbnail--holder">
                                                        <a href="{{ url('product/' . $row->pname . '/' . $row->addtocart) }}">
                                                            <img src="{{ $row->imgurl }}" alt="Product" width="344" height="370" />
                                                        </a>
                                                    </div>
                                                ...
                                                <h3 class="single-product__info--title d-flex align-items-center">
                                                    ...
                                                    @if ($row->quantity == 0)
                                                        <span class="badge ms-2" style="background: rgb(177, 51, 25); font-size: 10px;">
                                                            Out of Stock
                                                        </span>
                                                     @endif
                                                </h3>
                                                <p style="color:rgb(79, 78, 77)">{{ $row->company }}</p>
