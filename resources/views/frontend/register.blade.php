...
<main>
    ...
    <div class="login-register-section section-padding-2 d-flex align-items-center" style="min-height: 100vh;">
        <div class="container-fluid custom-container">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                    <div class="login-register p-4 border rounded shadow-sm">
                        <h3 class="login-register__title text-center">Register</h3>
                        @if ($message = Session::get('success'))
                            <div class="alert alert-success p-4 border-left-success">
                                <strong>{{ $message }}</strong>
                            </div>
                        @endif

                        @if ($message = Session::get('error'))
                            <div class="alert alert-danger p-4 border-left-danger">
                                <strong>{{ $message }}</strong>
                            </div>
                        @endif
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="login-register__form">
                                <div class="single-form mb-3">
                                    <input class="single-form__input form-control" type="text" placeholder="Full Name *"
                                ...
                                <div class="single-form mb-3">
                                    <input class="single-form__input form-control" type="email" placeholder="Email address *"
                                ...
                                <div class="single-form mb-3">
                                    <input class="single-form__input form-control" type="password" placeholder="Password *"
                                ...
                                <div class="single-form mb-3">
                                    <input class="single-form__input form-control" type="password" placeholder="Repeat Password *"
                                ...
                                <div class="single-form mb-3">
                                     <a href="{{ url('/user/login') }}">Already have an account? Please Login.</a>
                                </div>
                                <div class="single-form mb-3">
                                    <button class="single-form__btn btn btn-primary w-100">
                                        Register
                                    </button>
                                </div>
                            </div>
